...
console.log('task 3', addFlavor(originalFlavors, "Fior di Latte"))
...
console.log('task 4', removeLastFlavor(originalFlavors), is31Flavors(originalFlavors));
...
console.log('task 6', removeFlavorByName(originalFlavors, 'Pineapple Sherbet'), is31Flavors(originalFlavors));
...
console.log('task 7', filterByWord(originalFlavors, 'Ribbon'));

//Decided to keep original code from exercise we did together but wanted to see if I could "re-solve" it on my own
...
//     }
//   }
//   //we want the filtered array returned
//   return filteredArray;
// }
...
function getAverageWordLength(array){
  ...
  const finalArray = newArray.flat(2);

  return finalArray.length/array.length;
}
